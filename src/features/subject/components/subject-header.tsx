...
import { patchPartialSubjectNoteAction } from "../api/patch-partial-subject-action";
          ...
          <div className="min-h-6">
            {editingField === "description" ? (
              ...
              <p
                ...
                className="text-sm leading-relaxed text-foreground/80 cursor-pointer hover:bg-muted/50 rounded px-1 -ml-1 py-0.5 transition-colors border border-transparent hover:border-border hover:border-dashed min-h-6"
